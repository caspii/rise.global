...
For an [8-team bracket](/8-team-bracket/), expect 14-15 matches total (compared to 7 in single elimination). A [16-team bracket](/16-team-bracket/) runs 30-31 matches. The math roughly doubles, plus one for the potential reset.
